...
public class MahasiswaDemo08 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            arrayOfMahasiswa[i].nim = galuh.nextLine();
            System.out.print("Nama  : ");
            arrayOfMahasiswa[i].nama = galuh.nextLine();
            System.out.print("Kelas : ");
            arrayOfMahasiswa[i].kelas = galuh.nextLine();
        ...
        for (int i = 0; i < 3; i++) {
            arrayOfMahasiswa[i].cetakInfo(arrayOfMahasiswa[i].nim,
                    arrayOfMahasiswa[i].nama, arrayOfMahasiswa[i].kelas, arrayOfMahasiswa[i].ipk);
        }
